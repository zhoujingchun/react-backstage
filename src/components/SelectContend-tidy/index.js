...
class SelectConten extends Component {
    ...
    setTableList(res) {
        ...
        res.forEach((res, index) => {
            ...
            console.log(tags)
           // res.updated_at.slice(0, 13).replace(/\s|-/g, "/")
            data.push({
            ...
            <div>
                ...
                <div className="select-content">
                    ...
                    {/*标签部分*/}
                                ...
                                <Select  onChange={this.handleChange.bind(this)} showSearch style={{width: 300, flexGrow: 0}} placeholder="粗料/粗料待定/今日细料/细料反工"
                                        optionFilterProp="children">
                    ...
                    <Input onPressEnter={this.handleInput.bind(this)} style={{width: 200, marginLeft: "30px"}}
                           placeholder="      Input Value"/>
                                ...
                                <Select  onChange={this.handleSelChangeTwo.bind(this)} showSearch showSearch style={{marginLeft: "30px",width: 300, flexGrow: 0}} placeholder="标记为  细料/垃圾/粗料待定"
                                         optionFilterProp="children">
                ...
                <div style={{marginTop: "30px"}}>
                    ...
                    {/*将父级的data传给表格*/}
                    <TableTidy  handleTableChange={this.handleTableChange.bind(this)}   getSelectedRowKeys={this.getSelectedRowKeys.bind(this)} dataList={this.state.dataList}
                           cate={cate}/>
                </div>
